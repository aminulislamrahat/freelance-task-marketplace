    ...
    return (
        ...
        <footer className="bg-base-300 text-base-content px-4 md:px-10 lg:px-36 py-10 text-center">
            <div className="max-w-full mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <aside>
                    <Link className="flex items-center gap-3 font-bold text-xl text-primary">
                        <img
                            src={`${import.meta.env.BASE_URL}dotask_logo.png`}
                            alt="DoTask Logo"
                            className="w-full"
                        />
                    ...
                    <p className="text-xl mt-2 text-gray-500">
                        Connecting freelancers and job posters with ease.
                    </p>
                </aside>
            ...
            <div className="text-center text-xs text-gray-500 mt-10">
                © {new Date().getFullYear()} DoTask. All rights reserved.
            </div>
        </footer>
    );
};
