        ...
        <div className="w-full mx-auto bg-base-300 my-20 max-w-md p-4 rounded-md shadow sm:p-8">
            ...
            <div className="my-6">
                <button
                    ...
                    type="button"
                    className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md border-gray-600 hover:bg-primary hover:text-white transition cursor-pointer"
                >
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between mb-2">
                            ...
                            <a onClick={() => navigate('/forgot-password', { state: { email } })} className="text-xs hover:underline text-gray-600 cursor-pointer">Forgot password?</a>
                        </div>
